...
// ─── Real Chhattisgarh SVG (your uploaded file, viewBox preserved) ────────
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              display: "flex",
              flexDirection: "column",
              // KEY FIX: allow natural scroll inside the sticky pane
              overflowY: "auto",
              overflowX: "hidden",
            }}
          >
            ...
            {/*
              ── FIXED GRID ──────────────────────────────────────────────
              • Removed row-span / col-span from individual images — these
                caused hidden overflow when image count grew.
              • Simple uniform grid: 2 cols on mobile, 3 on md, 4 on lg.
              • Fixed card HEIGHT (200px) so the grid always has room.
              • Cards are absolutely positioned images so they fill correctly.
              ──────────────────────────────────────────────────────────── */}
            <div
              ...
              style={{
                gap: "4px",
                padding: "4px",
                flex: "0 0 auto", // don't stretch — let content define height
              }}
            >
              {TOURISM_IMAGES.map((image, index) => (
                <div
                  ...
                  style={{
                    ...
                    height: "200px", // fixed height — no implicit row needed
                  }}
                >
                  <Image
                    src={image.src}
