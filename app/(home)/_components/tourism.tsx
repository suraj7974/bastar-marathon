...
const TOURISM_IMAGES = [
  ...
  {
    src: "/images/tourism/danteshwari-temple.jpg",
    alt: "Danteshwari Temple",
    className: "col-span-1",
  },
  {
    src: "/images/tourism/bastar-forest.jpg",
    alt: "Lush Green Forests of Bastar",
      ...
      <div ref={scrollContainerRef} style={{ height: "520vh" }}>
        ...
        >
          ...
          >
            ...
            <div className="text-center flex-shrink-0" style={{ padding: "2.5rem 1rem 1.25rem" }}>
            ...
            <div
              className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 auto-rows-[220px] grid-flow-dense"
              style={{ flex: 1, gap: "4px", padding: "0 4px 4px" }}
            >
              {TOURISM_IMAGES.map((image, index) => (
                <div
                  ...
                  style={{ opacity: 0 }} // GSAP staggers each card in
                  className={`relative group overflow-hidden rounded-2xl shadow-md ${image.className ?? ""}`}
                >
                  <Image
                    src={image.src}
                    alt={image.alt}
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                    <p className="text-white font-medium text-base transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                      {image.alt}
                    </p>
                  </div>
                </div>
            ...
            {/* CTA button */}
            <div className="text-center flex-shrink-0" style={{ padding: "1.75rem 1rem 2.25rem" }}>
